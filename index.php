			...
			<div class="content-wrap"> 
				<div class="content">
					...
					<div class="welcome" class="accordion">
						...
						<div class="text-side">
							<p>Our proven "SoftWash System" has gently cleaned more than 50,000 properties nation wide since the early 1980's.  Because we do not use a power washer, our SoftWash System will not cause any damage to your roof shingles or siding.  The SoftWash System will help to protect your valuable investment as well as increase value and curb appeal.</p>
						</div></div>
...
//-->
					...
					<div class="technology" class="accordion">
						...
						<ol>
							...
							<li>SoftWash uses sodium hypochlorite (bleach), which is necessary to kill harmful algae, bacteria, mold, and fungus with nearly 100% efficiency.</li>
							<li>During use and disposal, 95% to 98% of bleach rapidly breaks down into salt and water, so there's no need to worry about environmental harm. The remaining byproducts are effectively treated by municipal wastewater and septic systems.</li>
							<li>Sodium hypochlorite is the same chemical used to treat our drinking water and sanitize and brighten our swimming pools. The notion that it will harm your roof is a scare tactic.</li>
							<li>SoftWash application is very fast and you'll see results immediately!</li>
					...
					<div class="FAQ" class="accordion">
						...
						<span class="question">"How long before I will see it work?"</span>
						...
						<span class="question">"How long will the washing last?"</span>
						...
						<span class="question">"Do I need to be home when you wash my roof?"</span>
						<p>No, the only thing we need is access to a water faucet and to make sure that all pets are indoors, and that all windows and doors are closed. On the other hand, if you would like to be home and watch this amazing process, that would be ok too.</p>
						<span class="question">"Will your chemicals kill my plants?"</span>
					...
					<div class="why" class="accordion"><span class="iconic arrow-d"></span><span class="iconic arrow-up"></span>
						<h2 class="bg-header">Why should I have my roof cleaned?</h2>
							...
							<ol>
								<li>Improve your curb appeal!  </li>
								<li>Decrease Utility costs!</li>
								<li>Maximize the longevity of your roof!</li>
								<li>Prevent insect infestations!</li>
								<li>Health benefits!</li>
								<li>5-year limited warranty!</li>
								<li>Maintain the value of your home or business!</li>
								<li>Clean it, Don't replace it!</li>
